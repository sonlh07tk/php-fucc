        ...
        <nav class="navbar navbar-default">
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> EDIT EXERCISE </a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 style="margin-bottom:10px"> <strong> Problem <?php echo $_proID.": ".$_data['problemName'] ?> </strong> </br> </h3>
                            </div>

                            <div class="content" style="overflow-x: auto;">
                                <form method="post">
                                    <div class="col-md-6">
                                    <label> New Name  </label> <input style="margin-bottom:10px" type="text" name="txtProName" required class = "form-control border-input"
                                    value="<?php echo $_data["problemName"] ?>"> 
                                    </div>
                                   
                                     <div class="col-md-6">
                                    <label> New Score </label> <input style="margin-bottom:10px" type="text" name="txtScore" required class = "form-control border-input"
                                    value="<?php echo $_data['point'] ?>"> 
                                    </div>
                                    ...
                                    <input class="btn btn-info btn-fill btn-wd" style="margin-top:10px" type="submit" name="bnAction" value="Update"/>
                                </form> 
                            </div>
