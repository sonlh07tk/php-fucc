            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">ALL YOUR SUBMISSIONS <?php if ($fill_problem != 0) { 
                                        $pro = getSingleProblem($fill_problem);

                                    ?>
                                        OF <strong> <?php if (isset($pro['problemName'])) echo $pro['problemName']; else echo "UNKNOW"; ?>
                                        <?php }?> </strong>
                                 </h4>
                  ...
                  <tbody>
                        ...
                        <tr>
                            <td>  <a href="showcode.php?id=<?php echo $row["subID"] ?>"> <?php echo $msgID ?> </a> </td>
